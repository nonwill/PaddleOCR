...
#define PD_DEFINE_VARIABLE(type, name, default_value, description)             \
  ...
  /* Register FLAG */                                                          \
  static ::paddle::flags::FlagRegisterer                                       \
      flag_##name##_registerer(#name, description, __FILE__,                   \
                               &FLAGS_##name##_default, &FLAGS_##name);        \
  }                                                                            \
  using paddle_flags::FLAGS_##name
...
public:
  template <typename T>
  FlagRegisterer(std::string name, std::string description, std::string file,
...
#define PHI_DEFINE_string(name, val, txt)                                      \
  ...
  static GFLAGS_NAMESPACE::FlagRegisterer                                      \
      o_##name(#name, MAYBE_STRIPPED_HELP(txt), __FILE__,                      \
               &FLAGS_##name##_current, &FLAGS_##name##_default);              \
...
#define __PHI_DEFINE_EXPORTED_FLAG(__name, __is_writable, __cpp_type,          \
...
#define PHI_DEFINE_EXPORTED_string(name, default_value, doc)                   \
  __PHI_DEFINE_EXPORTED_FLAG(name, true, ::std::string, string, default_value, \
                             doc)
