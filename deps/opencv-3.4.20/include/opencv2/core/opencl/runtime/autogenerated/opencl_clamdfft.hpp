...
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftBakePlan)(
    clAmdFftPlanHandle plHandle, cl_uint numQueues,
    cl_command_queue *commQueueFFT,
    void(CL_CALLBACK *pfn_notify)(clAmdFftPlanHandle plHandle, void *user_data),
    void *user_data);
// extern CL_RUNTIME_EXPORT clAmdFftStatus
// (*clAmdFftCopyPlan)(clAmdFftPlanHandle* out_plHandle, cl_context new_context,
// clAmdFftPlanHandle in_plHandle);
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftCreateDefaultPlan)(
...
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftEnqueueTransform)(
    clAmdFftPlanHandle plHandle, clAmdFftDirection dir,
    cl_uint numQueuesAndEvents, cl_command_queue *commQueues,
    cl_uint numWaitEvents, const cl_event *waitEvents, cl_event *outEvents,
    cl_mem *inputBuffers, cl_mem *outputBuffers, cl_mem tmpBuffer);
// extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetLayout)(const
// clAmdFftPlanHandle plHandle, clAmdFftLayout* iLayout, clAmdFftLayout*
// oLayout); extern CL_RUNTIME_EXPORT clAmdFftStatus
// (*clAmdFftGetPlanBatchSize)(const clAmdFftPlanHandle plHandle, size_t*
// batchSize); extern CL_RUNTIME_EXPORT clAmdFftStatus
// (*clAmdFftGetPlanContext)(const clAmdFftPlanHandle plHandle, cl_context*
// context); extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanDim)(const
// clAmdFftPlanHandle plHandle, clAmdFftDim* dim, cl_uint* size); extern
// CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanDistance)(const
// clAmdFftPlanHandle plHandle, size_t* iDist, size_t* oDist); extern
// CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanInStride)(const
// clAmdFftPlanHandle plHandle, const clAmdFftDim dim, size_t* clStrides);
// extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanLength)(const
// clAmdFftPlanHandle plHandle, const clAmdFftDim dim, size_t* clLengths);
// extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanOutStride)(const
// clAmdFftPlanHandle plHandle, const clAmdFftDim dim, size_t* clStrides);
// extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanPrecision)(const
// clAmdFftPlanHandle plHandle, clAmdFftPrecision* precision); extern
// CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanScale)(const
// clAmdFftPlanHandle plHandle, clAmdFftDirection dir, cl_float* scale); extern
// CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetPlanTransposeResult)(const
// clAmdFftPlanHandle plHandle, clAmdFftResultTransposed* transposed); extern
// CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetResultLocation)(const
// clAmdFftPlanHandle plHandle, clAmdFftResultLocation* placeness);
extern CL_RUNTIME_EXPORT
    clAmdFftStatus (*clAmdFftGetTmpBufSize)(const clAmdFftPlanHandle plHandle,
                                            size_t *buffersize);
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftGetVersion)(cl_uint *major,
                                                              cl_uint *minor,
                                                              cl_uint *patch);
extern CL_RUNTIME_EXPORT
    clAmdFftStatus (*clAmdFftSetLayout)(clAmdFftPlanHandle plHandle,
                                        clAmdFftLayout iLayout,
                                        clAmdFftLayout oLayout);
extern CL_RUNTIME_EXPORT
    clAmdFftStatus (*clAmdFftSetPlanBatchSize)(clAmdFftPlanHandle plHandle,
                                               size_t batchSize);
// extern CL_RUNTIME_EXPORT clAmdFftStatus
// (*clAmdFftSetPlanDim)(clAmdFftPlanHandle plHandle, const clAmdFftDim dim);
extern CL_RUNTIME_EXPORT
    clAmdFftStatus (*clAmdFftSetPlanDistance)(clAmdFftPlanHandle plHandle,
                                              size_t iDist, size_t oDist);
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftSetPlanInStride)(
    clAmdFftPlanHandle plHandle, const clAmdFftDim dim, size_t *clStrides);
// extern CL_RUNTIME_EXPORT clAmdFftStatus
// (*clAmdFftSetPlanLength)(clAmdFftPlanHandle plHandle, const clAmdFftDim dim,
// const size_t* clLengths);
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftSetPlanOutStride)(
    clAmdFftPlanHandle plHandle, const clAmdFftDim dim, size_t *clStrides);
extern CL_RUNTIME_EXPORT
    clAmdFftStatus (*clAmdFftSetPlanPrecision)(clAmdFftPlanHandle plHandle,
                                               clAmdFftPrecision precision);
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftSetPlanScale)(
    clAmdFftPlanHandle plHandle, clAmdFftDirection dir, cl_float scale);
// extern CL_RUNTIME_EXPORT clAmdFftStatus
// (*clAmdFftSetPlanTransposeResult)(clAmdFftPlanHandle plHandle,
// clAmdFftResultTransposed transposed);
extern CL_RUNTIME_EXPORT clAmdFftStatus (*clAmdFftSetResultLocation)(
    clAmdFftPlanHandle plHandle, clAmdFftResultLocation placeness);
extern CL_RUNTIME_EXPORT
    clAmdFftStatus (*clAmdFftSetup)(const clAmdFftSetupData *setupData);
