...
#define CV_INTRIN_DEF_TYPE2VEC128_TRAITS(type_, vec_type_)                     \
  template <> struct Type2Vec128_Traits<type_> { typedef vec_type_ vec_type; }
...
#define CV_INTRIN_DEF_TYPE2VEC256_TRAITS(type_, vec_type_)                     \
  template <> struct Type2Vec256_Traits<type_> { typedef vec_type_ vec_type; }
...
#define CV_INTRIN_DEF_TYPE2VEC512_TRAITS(type_, vec_type_)                     \
  template <> struct Type2Vec512_Traits<type_> { typedef vec_type_ vec_type; }
