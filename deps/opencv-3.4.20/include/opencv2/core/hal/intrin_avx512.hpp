...
#define OPENCV_HAL_IMPL_AVX512_CMP_OP_INT(_Tpvec, sufcmp, sufset, tval)        \
  OPENCV_HAL_IMPL_AVX512_CMP_INT(==, _MM_CMPINT_EQ, _Tpvec, sufcmp, sufset,    \
                                 tval)                                         \
  OPENCV_HAL_IMPL_AVX512_CMP_INT(!=, _MM_CMPINT_NE, _Tpvec, sufcmp, sufset,    \
                                 tval)                                         \
  OPENCV_HAL_IMPL_AVX512_CMP_INT(<, _MM_CMPINT_LT, _Tpvec, sufcmp, sufset,     \
                                 tval)                                         \
  OPENCV_HAL_IMPL_AVX512_CMP_INT(>, _MM_CMPINT_NLE, _Tpvec, sufcmp, sufset,    \
                                 tval)                                         \
  OPENCV_HAL_IMPL_AVX512_CMP_INT(<=, _MM_CMPINT_LE, _Tpvec, sufcmp, sufset,    \
                                 tval)                                         \
  OPENCV_HAL_IMPL_AVX512_CMP_INT(>=, _MM_CMPINT_NLT, _Tpvec, sufcmp, sufset,   \
                                 tval)
...
#define OPENCV_HAL_IMPL_AVX512_CMP_OP_FLT(_Tpvec, sufcmp, sufset, tval)        \
  ...
  OPENCV_HAL_IMPL_AVX512_CMP_FLT(!=, _CMP_NEQ_OQ, _Tpvec, sufcmp, sufset,      \
                                 tval)                                         \
...
inline v_int8x64 v_rotate_right(const v_int8x64 &a, const v_int8x64 &b) {
  return imm >= 128
             ...
             v_int8x64(_mm512_permutex2var_epi8(
                 ...
                 b.val));
#else
             _v_rotate_right<imm % 4 != 0, imm % 4, (imm / 4 > 15),
                             imm / 4>::eval(a, b);
#endif
}
template <int imm>
...
inline float v_reduce_sad(const v_float32x16 &a, const v_float32x16 &b) {
  return v_reduce_sum((a - b) & v_float32x16(_mm512_castsi512_ps(
                                    _mm512_set1_epi32(0x7fffffff))));
}
inline double v_reduce_sad(const v_float64x8 &a, const v_float64x8 &b) {
  return v_reduce_sum((a - b) & v_float64x8(_mm512_castsi512_pd(
