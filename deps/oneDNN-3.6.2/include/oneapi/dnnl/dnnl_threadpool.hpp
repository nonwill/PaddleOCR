...
inline dnnl::stream make_stream(const dnnl::engine &aengine,
...
inline status sgemm(char transa, char transb, dnnl_dim_t M, dnnl_dim_t N,
                    ...
                    dnnl_dim_t ldc, threadpool_iface *threadpool) {
  return static_cast<status>(
      dnnl_threadpool_interop_sgemm(transa, transb, M, N, K, alpha, A, lda, B,
                                    ldb, beta, C, ldc, threadpool));
}
...
inline status gemm_u8s8s32(char transa, char transb, char offsetc, dnnl_dim_t M,
                           ...
                           const int32_t *co, threadpool_iface *threadpool) {
  return static_cast<status>(dnnl_threadpool_interop_gemm_u8s8s32(
      transa, transb, offsetc, M, N, K, alpha, A, lda, ao, B, ldb, bo, beta, C,
      ldc, co, threadpool));
}
...
inline status gemm_s8s8s32(char transa, char transb, char offsetc, dnnl_dim_t M,
                           ...
                           float beta, int32_t *C, dnnl_dim_t ldc,
                           const int32_t *co, threadpool_iface *threadpool) {
  return static_cast<status>(dnnl_threadpool_interop_gemm_s8s8s32(
      transa, transb, offsetc, M, N, K, alpha, A, lda, ao, B, ldb, bo, beta, C,
      ldc, co, threadpool));
}
