...
extern CPPOCR_API int ppocr_from_args(CPPOCR *cppocr, int argc,
                                      char **argv) noexcept;
extern CPPOCR_API int ppocr_from_inis(CPPOCR *cppocr,
                                      char const *inis) noexcept;
extern CPPOCR_API int ppocr_from_sxml(CPPOCR *cppocr,
                                      char const *xmlfile) noexcept;

extern CPPOCR_API int ppocr_cmd(CPPOCR cppocr,
                                PPPOcrResult *result = nullptr) noexcept;
