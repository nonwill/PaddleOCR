...
DEFINE_string(type, "ocr", "Perform function, be one of ocr/structure")
...
DEFINE_string(limit_type, "max", "limit_type of input image, be one of min/max")
...
DEFINE_string(rec_char_dict_path, "./ppocr_keys_v1.txt",
                          "Path of dictionary.")
DEFINE_int32(rec_img_h, 48, "rec image height, set 32 for PP-OCRv2 or older version.")
